...
public class EditorInstance extends JPanel implements ActionListener, ListSelectionListener, Panel {
	...
	EditorInstance(int Instancenb, boolean a) {
		isWorkshop = a;
		...
		combolist = new String[] { "default", "Instance" };
		comboBox = new JComboBox<String>(combolist);
		if (instance.getSaveLocation() != "default" && instance.getSaveLocation() != null) {
